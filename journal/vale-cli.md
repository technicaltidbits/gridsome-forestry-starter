...
excerpt: Learn how to install the Vale CLI in this tutorial - for Mac and Windows!
---
...
Mac users, click [here](https://technicaltidbits.net/vale-series/install-vale-mac).

Windows users, click [here](https://technicaltidbits.net/vale-series/install-vale-windows).
